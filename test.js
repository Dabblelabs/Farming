...
var keyPressSettings = {
    ...
    "priorityFourEnabled": true,
    "priorityFourProfile": "Default",
    "priorityFourButton": "Skip",
    "defaultButton": "Skip"
};
...
function createProfile() {
    ...
    if (profileName != null && profileName != "") {
        ...
        window.top.$('#priorityFourProfile').append("<option value='" + profileName + "'>" + profileName + "</option>");
...
function deleteProfile() {
    ...
    if (profileName == profile_10) {
        ...
        window.top.$("#priorityFourProfile option[value='" + profileName + "']").remove();
...
function updateKeypressSettings() {
    ...
    keyPressSettings.priorityFourEnabled = window.top.$('#priorityFourEnabled').prop('checked');
    keyPressSettings.priorityFourProfile = window.top.$('#priorityFourProfile').val();
    keyPressSettings.priorityFourButton = window.top.$('#priorityFourButton').val();
...
function fillKeypressSettings() {
    ...
    window.top.$('#priorityFourEnabled').prop('checked', keyPressSettings.priorityFourEnabled);
    window.top.$('#priorityFourProfile').val(keyPressSettings.priorityFourProfile);
    window.top.$('#priorityFourButton').val(keyPressSettings.priorityFourButton);
...
function fillMasterSettings() {
    ...
    window.top.$.each(profileList, function (i, val) {
        ...
        window.top.$('#priorityFourProfile').append("<option value='" + val + "'>" + val + "</option>");
    });
}
function selectMasterButton(row) {
    ...
    var p3 = window.top.$.jStorage.get("profile:" + keyPressSettings.priorityFourProfile);
    var aButton = row.children("td").eq(9).children("a");
    var bButton = row.children("td").eq(10).children("a");
    var cButton = row.children("td").eq(11).children("a");
    buttonToClick = keyPressSettings.defaultButton;
    if (keyPressSettings.priorityFourEnabled && !checkRowToHide(row, p2)) {
        buttonToClick = keyPressSettings.priorityFourButton;
    }
